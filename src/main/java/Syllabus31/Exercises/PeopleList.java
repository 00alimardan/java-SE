...
//        people.add(new Person("ChildName12","ChildSurname12",12, Gender.MALE,
...
//
//        people.add(new Person("ChildName15","ChildSurname15",15, Gender.MALE,
...
//
//        people.add(new Person("ChildName6","ChildSurname6",6, Gender.MALE,
...
//
//        people.add(new Person("ChildName8","ChildSurname8",8, Gender.MALE,
